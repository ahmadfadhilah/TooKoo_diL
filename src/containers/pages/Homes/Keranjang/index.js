  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        <View style={{flexDirection: 'row', marginBottom: 16, paddingTop: 18, marginHorizontal: 14}}>
          <View>
            <Image source={require('../../../../assets/icon/46.jpeg')} style={{width: 100, height: 100, borderRadius: 3}}/>
          </View>
          <View style={{marginLeft: 16, flex: 1}}>
            <Text style={{fontSize: 14, color: '#2E2E2E', fontWeight: '600', marginBottom: 4}}>Custom Men's Shoe</Text>
            <Text style={{fontSize: 18, color: '#2E2E2E', fontWeight: 'bold', marginBottom: 26}}>Air Jordan 1 Mid</Text>
            <Text style={{fontSize: 18, width: '80%', color: '#1C1C1C', backgroundColor: '#EFEBE0'}}>Rp 5,000,000</Text>
          </View>
        </View>
        <View style={{height: 10, backgroundColor: '#DBE8D8'}}></View>
        <View style={{flexDirection: 'row', marginBottom: 16, paddingTop: 18, marginHorizontal: 14}}>
          ...
          <View style={{marginLeft: 16, flex: 1}}>
            <Text style={{fontSize: 14, color: '#2E2E2E', fontWeight: '600', marginBottom: 4}}>Custom Men's Shoe</Text>
            <Text style={{fontSize: 18, color: '#2E2E2E', fontWeight: 'bold', marginBottom: 26}}>Nike Blazer Mid</Text>
            <Text style={{fontSize: 18, width: '80%', color: '#1C1C1C', backgroundColor: '#EFEBE0'}}>Rp 3,453,000</Text>
          </View>
        </View>
      </View>
    )

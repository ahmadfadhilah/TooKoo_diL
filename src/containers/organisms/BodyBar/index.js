    ...
    render() {
        return (
            <View style={{ marginHorizontal: 16, marginTop: 9 }}>
              <View style={{flexDirection: 'row', justifyContent: 'space-between', backgroundColor: '#f7ff00', borderTopLeftRadius: 4, borderTopRightRadius: 4, padding: 13}}>
              ...
              <View style={{flexDirection: 'row', paddingTop: 20, paddingBottom: 14, backgroundColor: '#db36a4', borderBottomLeftRadius: 4, borderBottomRightRadius: 4}}>

    ...
    render() {
        return (
            <View style={{ marginHorizontal: 16, marginTop: 18 }}>
              <View style={{flexDirection: 'row', justifyContent: 'space-between', backgroundColor: '#68BBE3', borderTopLeftRadius: 4, borderTopRightRadius: 4, padding: 13}}>
                ...
                <Text style={{fontSize: 16, fontWeight: 'bold', color: 'white'}}>Rp 10.000</Text>
              </View>
              <View style={{flexDirection: 'row', paddingTop: 20, paddingBottom: 14, backgroundColor: '#0476D0', borderBottomLeftRadius: 4, borderBottomRightRadius: 4, marginBottom: 15}}>
